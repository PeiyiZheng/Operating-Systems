...
struct proc {
  ...
  int priority;                // OS Assignment 3. -2 highest priority
       //+2 is lowest priority.
  struct chanvar *cv;           // OS Assignment 3. A pointer to procs on channel, replaces channel.
  int allowedRuntime;           //
};

struct chanvar {
    struct proc *procswaiting;
};
